                    ...
                    <>
                      <div className="p-8 border-b border-slate-100 flex justify-between items-center bg-slate-50/30">
                          ...
                          <div className="flex items-center space-x-2">
                            ...
                            <button className="p-3 bg-blue-50 text-blue-600 rounded-xl hover:bg-blue-600 hover:text-white transition-all shadow-sm"><FileUp size={18}/></button>
                          </div>
                      </div>
        ...
        <div className="fixed inset-0 bg-slate-900/60 backdrop-blur-sm z-[2000] flex items-center justify-center p-4">
          <div className="bg-white rounded-[3rem] max-w-sm w-full p-10 shadow-2xl relative border border-amber-100 animate-in zoom-in duration-200">
            ...
            <form onSubmit={handleReclassifySubmit} className="space-y-4">
              <div><label className="text-[9px] font-black text-slate-400 uppercase tracking-widest ml-1">Nova Posição Sugerida</label>
              <input type="number" value={newRankingValue} onChange={e => setNewRankingValue(Number(e.target.value))} required className="mt-1 w-full border border-slate-200 rounded-2xl p-4 text-sm font-bold bg-slate-50 outline-none focus:ring-4 focus:ring-amber-500/10 transition-all" /></div>
              <div className="flex justify-end gap-3 mt-8">
        ...
        <div className="fixed inset-0 bg-slate-900/60 backdrop-blur-sm z-[2000] flex items-center justify-center p-4">
          <div className="bg-white rounded-[3rem] max-w-sm w-full p-12 shadow-2xl relative border border-red-100 animate-in zoom-in duration-200">
            ...
            <div className="flex flex-col items-center text-center">
                ...
                <p className="text-xs text-slate-500 font-medium leading-relaxed mb-8 px-2">Você confirma a desistência formal de <strong>{declineTarget.name}</strong>? Esta ação é irreversível e o candidato será inabilitado permanentemente deste edital.</p>
                <div className="flex flex-col w-full gap-3">
                    ...
                    <button onClick={() => setShowDeclineModal(false)} className="w-full py-4 bg-white text-slate-400 font-black text-[10px] uppercase rounded-2xl border border-slate-100 hover:bg-slate-50 transition-all">Manter na Lista</button>
                </div>
            </div>
          </div>
        </div>
