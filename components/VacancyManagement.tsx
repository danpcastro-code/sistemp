          ...
          <div className="bg-white p-10 rounded-[3.5rem] border border-slate-200 shadow-2xl shadow-slate-200/50 relative">
            ...
            <div className="bg-slate-50 p-8 rounded-[2.5rem] border border-slate-100 mb-10">
              <div className="flex items-center space-x-3 mb-6">
                  ...
                  <h3 className="text-[10px] font-black uppercase tracking-widest text-slate-500">Conjunto de Vagas Disponíveis</h3>
              </div>
                ...
                <table className="w-full text-left">
                    <thead className="bg-slate-50 text-[10px] uppercase font-black text-slate-400 border-b border-slate-100">
                        <tr>
                            ...
                            <th className="px-8 py-6 text-center">Tempo Limite</th>
